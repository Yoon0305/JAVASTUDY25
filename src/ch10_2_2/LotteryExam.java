package ch10_2_2; //REVIEW 필요, 45초과 1미만 숫자에 대한 조건 부여 필요
...
public class LotteryExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("로또 1부터 45까지의 번호 중 6개를 선택해주세요");
		...
		++x;}
		 ...
		 if (x==0) {System.out.println("번호가 하나도 맞지않았습니다");
		 if (x==1) {System.out.println("축하합니다. 번호가1개맞았습니다");
		 if (x==2) {System.out.println("축하합니다. 번호가2개맞았습니다");
		 if (x==3) {System.out.println("축하합니다. 번호가3개맞았습니다");
		 if (x==4) {System.out.println("축하합니다. 번호가4개맞았습니다");
		 if (x==5) {System.out.println("축하합니다. 번호가5개맞았습니다");
		 if (x==6) {System.out.println("축하합니다. 번호가6개맞았습니다");
		 }
		 }
		 }
		 }
